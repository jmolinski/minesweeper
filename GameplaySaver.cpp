...
bool GameplaySaver::load(Board* board, bool& show_zeros, UI& flags, bool& lose)
{
    ...
    if(saved_progress.good() == false)
        return false;
    saved_progress >> board_size >> bombs_amount;
    board = new Board(board_size);
    board->set_bombs_amount(bombs_amount);
    saved_progress >> show_zeros >> flags >> lose;
...
void GameplaySaver::save(Board* board, bool show_zeros, UI flags, bool lose)
{
